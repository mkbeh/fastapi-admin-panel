...
def with_errors(*errors: Union[AppException, HTTPException, Callable[..., HTTPException]]):
    d = {}
    for err in errors:
        err_factory = err
